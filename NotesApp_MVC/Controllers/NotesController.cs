...
using NotesApp_MVC.Data;
using NotesApp_MVC.Models;

namespace NotesApp_MVC.Controllers
{
    [Authorize]
    public class NotesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            notes = notes.Where(n => n.UserId == User.FindFirstValue(ClaimTypes.NameIdentifier));
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Content,UserId")] Note note)
        {
